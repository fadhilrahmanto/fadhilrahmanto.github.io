            ...
            <div class="container text-center mt-1 py-5">
                ...
                <?php $ambil = $koneksi->query("SELECT * FROM tb_kategori WHERE idk = $idk"); ?>
                    <?php while ( $kat = $ambil->fetch_assoc()){ ?>
                        <h3>Hasil Pencarian : <?= $kat['nama_kategori'] ?> </h3>
                    <?php } ?>
                <!-- end nama kategori -->
                <hr>
                ...
                <div class="row">
                    <?php 
                        $brgs=mysqli_query($koneksi,"SELECT * from tb_produk where idk='$idk' order by idp ASC"); 
                ...
                <div class="lainnya mt-5">
                    <div class="container">
                        <?php
                            $queryJmlData = "SELECT * from tb_produk where idk='$idk' order by idp ASC";
